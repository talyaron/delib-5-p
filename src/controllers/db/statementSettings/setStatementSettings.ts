import { Collections, Statement, StatementSettings } from "delib-npm";
import { doc, setDoc } from "firebase/firestore";
import { FireStore } from "../config";


interface SetStatementSettingsProps { statement: Statement, property: keyof StatementSettings, newValue: boolean, settingsSection: keyof Statement }
